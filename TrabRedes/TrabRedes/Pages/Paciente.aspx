<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MasterPage.Master" AutoEventWireup="true" CodeBehind="Paciente.aspx.cs" Inherits="TrabRedes.Pages.Paciente" %>
            ...
            <table id="tableLista" class="SMA-table table table-striped cell-border display w-100">
                <thead>
                    <tr class="headings">
                        ...
                        <th class="column-title sorting_asc_disabled sorting_desc_disabled" data-priority="1" style="display: table-cell;">CONVENIO</th>
                        <th class="column-title sorting_asc_disabled sorting_desc_disabled" data-priority="1" style="display: table-cell;">TIPO SANGUE</th>
                        <th data-priority="1" style="display: table-cell; width: 1%"></th>
                    </tr>
                </thead>
                <tbody>
            ...
            <div class="card mt-3 card-info">
                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-md-2">
                            <span>* CONVENIO:</span>
                            <asp:DropDownList ID="ddlconvenio" runat="server" CssClass="form-control form-control-sm"></asp:DropDownList>                                                   
                        </div>
                         <div class="col-md-2">
                            <span>* SANGUE:</span>
                            <asp:DropDownList ID="ddlsangue" runat="server" CssClass="form-control form-control-sm"></asp:DropDownList>                                                   
                        </div>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">
        ...
        function openEdit(t) {
            ...
            if (t == "NOVO") {
                ...
                location.href = '../Pages/Paciente.aspx';
